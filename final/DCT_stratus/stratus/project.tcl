...
define_hls_module DFT1 ../DFT1.cpp

### 4. Define your HLS configuration (arbitrary names, BASIC and DPA in this example). 
define_hls_config DFT1 BASIC
define_hls_config DFT1 DPA       --dpopt_auto=op,expr
...
define_sim_config V_BASIC "DFT1 RTL_V BASIC"
### 5.3 The Verilog simulation for HLS config "DPA". 
define_sim_config V_DPA "DFT1 RTL_V DPA"
