...
public:
	...
	addr_t DFT0_start_addr = 0x80000000;
 	addr_t DFT0_size = 0x01000000;
 	addr_t DFT0_end_addr = DFT0_start_addr + DFT0_size - 1;
	addr_t DFT1_start_addr = 0x90000000;
 	addr_t DFT1_size = 0x01000000;
 	addr_t DFT1_end_addr = DFT1_start_addr + DFT1_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > DFT0_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	core0.init(instr_mem_if0, data_mem_if0, &clint, entry_point, rv32_align_address(opt.mem_end_addr));
	core1.init(instr_mem_if1, data_mem_if1, &clint, entry_point, rv32_align_address(opt.mem_end_addr));
	...
	bus.ports[12] = new PortMapping(opt.DFT0_start_addr, opt.DFT0_end_addr);
	bus.ports[13] = new PortMapping(opt.DFT1_start_addr, opt.DFT1_end_addr);
	...
	bus.isocks[12].bind(dft0.tsock);
	bus.isocks[13].bind(dft1.tsock);
