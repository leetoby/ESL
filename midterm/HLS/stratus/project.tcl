...
define_hls_module Quad ../Quad.cpp

### 4. Define your HLS configuration (arbitrary names, BASIC and DPA in this example). 
define_hls_config Quad BASIC
define_hls_config Quad DPA       --dpopt_auto=op,expr
...
define_sim_config V_BASIC "Quad RTL_V BASIC"
### 5.3 The Verilog simulation for HLS config "DPA". 
define_sim_config V_DPA "Quad RTL_V DPA"
